...
// ── Shared dirty browns/greys for all factions ──
        // 23=#7f6b60  25=#b6aba7  30=#cac1ba  97=#3d2f22
        // 99=#453e38  110=#cacccb  156=#b3a491  157=#5f4f44

        // ── Battania (Celtic — forest greens, mustards, earth browns) ──
        private static readonly uint[] BattaniaPrimary = new uint[]
        {
            0xFF284E19, 0xFF7F6B60, 0xFFCDA87C, 0xFF975B43,
            0xFF7B5E4E, 0xFF7E6E4A, 0xFF3A3321, 0xFF5D5B44, 0xFF726B3D,
            0xFFA97435, 0xFF34671E, 0xFF5F4F44, 0xFFB6ABA7, 0xFFCAC1BA,
            0xFF3D2F22, 0xFF453E38, 0xFFB3A491
        };
        private static readonly uint[] BattaniaSecondary = BattaniaPrimary;

        // ── Aserai (Arabian — creams, sands, saffron) ──
        private static readonly uint[] AseraiPrimary = new uint[]
        {
            0xFFEFC990, 0xFFE7D3BA, 0xFFECE8DD,
            0xFFDCAC46, 0xFFE9E2C5, 0xFFEBDCBB, 0xFFE0C78E, 0xFFCDA87C,
            0xFFE6A57F, 0xFFB3A491, 0xFF7F6B60, 0xFFB6ABA7, 0xFFCAC1BA,
            0xFF3D2F22, 0xFF453E38, 0xFF5F4F44
        };
        ...
        private static readonly uint[] VlandiaPrimary = new uint[]
        {
            ...
            0xFF7B5E4E, 0xFF3D2F22, 0xFF453E38, 0xFF2C4D86,
            0xFF8D5C44, 0xFFB3A491, 0xFF5F4F44, 0xFFCACCCB
        };
        ...
        private static readonly uint[] KhuzaitPrimary = new uint[]
        {
            ...
            0xFF8D5C44, 0xFF5F4F44, 0xFF7F6B60, 0xFFB6ABA7, 0xFFCAC1BA,
            0xFFB3A491
        };
        ...
        private static readonly uint[] SturgiaPrimary = new uint[]
        {
            ...
            0xFF2C4D86, 0xFF5F4F44, 0xFFB3A491
        };
        ...
        private static readonly uint[] NordPrimary = new uint[]
        {
            ...
            0xFF2C4D86, 0xFF5F4F44, 0xFFB3A491, 0xFFCACCCB
        };
        ...
        {
            0xFF8D291A, 0xFF7F6B60, 0xFF967E7E, 0xFFCAC1BA,
            0xFFDCAC46, 0xFFCDA87C, 0xFFBD7E75, 0xFF975B43, 0xFFAC9188,
            0xFF6C1512, 0xFFB3A491, 0xFF5F4F44, 0xFFB6ABA7,
            0xFF3D2F22, 0xFF453E38, 0xFFCACCCB
        };
        ...
        private static readonly uint[] FallbackPrimary = new uint[]
        {
            ...
            0xFFCDA87C, 0xFF975B43, 0xFF7B5E4E, 0xFFB3A491, 0xFF5F4F44,
            0xFFCACCCB
        };
