    ...
    internal class BodyProperty_Patch
    {
        ...
        public class ADCCultureFaceKeyPatch
        {
            ...
            private static void Postfix(CharacterCreationCultureVM selectedCulture)
            {
                ...
                dic.Add(cultures.First((CultureObject x) => x.StringId == "svadia"), "<BodyProperties version='4' age='25.84' weight='0.5000' build='0.5000'  key='0005B80E4000300F7C7664876753888A574A866254C69643A45D951A48A7A72700777603073C7D4300000000000000000000000000000000000000003AF43082'/>");
